        ...
        <div className="container">
          <div className="md:grid gap-8 md:grid-cols-12 pt-16 pb-14">
            ...
            <div className="xl:col-span-4 lg:col-span-4 md:col-span-12 mb-10 xl:mb-0 xl:pr-10">
              ...
              >
                This is an online book reading platform{" "}
                <br className="hidden xl:inline" /> where you can read and share
                books <br className="hidden xl:inline" /> through a different
                book freak individual <br className="hidden xl:inline" /> of
                different choice
              </p>
              <div className="text-xss1 text-white font-normal leading-6 mb-4 flex gap-4 items-center">
                <ImLocation2 className="h-6 w-6 text-themePrimary cursor-pointer" />
              ...
              >
                <FaPhoneSquare className="h-6 w-6 text-themePrimary cursor-pointer" />
                1-123-567-89
              </a>
              <a
              ...
              >
                <MdEmail className="h-6 w-6 text-themePrimary cursor-pointer" />
            ...
            <div className="xl:col-span-3 lg:col-span-3 md:col-span-6 mb-10 xl:mb-0">
              ...
              {quickLink.map((item, index) => (
                <Link to={item.link} key={index}>
                  <p className="text-xs text-themeLighter  font-normal leading-6 mb-4 block transition-all duration-300 hover:text-themePrimary">
                    {item.name}
                  </p>
                </Link>
              ))}
          ...
          >
            <p className="text-xss text-white leading-4">
              © {FullYear} Octova | All Right Reserved
            </p>
          </div>
        </div>
      </footer>
